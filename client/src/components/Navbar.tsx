...
const navItems = [
  ...
  },
  {
    ...
    href: "/courses",
    children: [
      { label: "初級課程", href: "/courses#beginner" },
      { label: "中級課程", href: "/courses#intermediate" },
      { label: "高級課程", href: "/courses#advanced" },
  ...
  },
  {
    ...
    href: "/admissions",
    children: [
      { label: "招生對象", href: "/admissions#target" },
      { label: "申請流程", href: "/admissions#process" },
      { label: "學費與獎學金", href: "/admissions#fees" },
    ],
  },
